...
region = {
    ...
    "tt_visits": {
        ...
        "descriptions": [*base_field["tt_visits"]["descriptions"], "Field ID nr."],
        "meta": {**base_field["tt_visits"]["meta"]},
    },
    "tt_coverage_hp": {
    ...
    "tt_ref_sources": {
        ...
        "descriptions": [*base_field["tt_ref_sources"]["descriptions"], "Field ID nr."],
        "meta": {**base_field["tt_ref_sources"]["meta"]},
    },
    "tt_detections": {
        "names": [*base_field["tt_detections"]["names"], "field_id"],
        "dtype": [*base_field["tt_detections"]["dtype"], "int64"],
        "units": [*base_field["tt_detections"]["units"], "1"],
        "defaults": [*base_field["tt_detections"]["defaults"], -1],
        "descriptions": [*base_field["tt_detections"]["descriptions"], "Field ID nr."],
        "meta": {**base_field["tt_detections"]["meta"]},
    },
    "tt_sources": {
        "names": [*base_field["tt_sources"]["names"], "field_id"],
        "dtype": [*base_field["tt_sources"]["dtype"], "int64"],
        "units": [*base_field["tt_sources"]["units"], "1"],
        "defaults": [*base_field["tt_sources"]["defaults"], -1],
        "descriptions": [*base_field["tt_sources"]["descriptions"], "Field ID nr."],
        "meta": {**base_field["tt_sources"]["meta"]},
    },
    "ta_sources_lc": {
        "names": [*base_field["ta_sources_lc"]["names"], "field_id"],
        "dtype": [*base_field["ta_sources_lc"]["dtype"], "int64"],
        "units": [*base_field["ta_sources_lc"]["units"], "1"],
        "defaults": [*base_field["tt_sources"]["defaults"], -1],
        "descriptions": [*base_field["ta_sources_lc"]["descriptions"], "Field ID nr."],
